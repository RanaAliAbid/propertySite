...
<?php get_header();?>
 ...
 <ul class="slider" id="fullscreen-slider">
        <li><img src="<?php bloginfo('template_directory');?>/images/slides/slider2.jpg" alt="slide1"/></li>
          <li><img src="<?php bloginfo('template_directory');?>/images/slides/slider3.jpg" alt="slide2"/></li>
          <li><img src="<?php bloginfo('template_directory');?>/images/slides/slider2.jpg" alt="slide3"/></li>
      </ul>
						...
						<div class="col-md-3 animation">
							<div class="offer-item pgl-bg-light">
								<div class="offer-item-inner">
									<p><i class="icons icon-eco"></i></p>
									<h3>ECO-FRIENDLY</h3>
									<p>The materials we use in prefabricated production are recyclable and reusable products.</p>
								</div>
							</div>
						</div>
						<div class="col-md-3 animation">
							<div class="offer-item pgl-bg-light">
								<div class="offer-item-inner">
									<p><i class="icons icon-bus"></i></p>
									<h3>FAST DELIVERY</h3>
									<p>Delivery between 7 and 14 days depending on the square meter of your order with fast delivery!     </p>
								</div>
							</div>
						</div>
						<div class="col-md-3 animation">
							<div class="offer-item pgl-bg-light">
								<div class="offer-item-inner">
									<p><i class="icons icon-check"></i></p>
									<h3>GUARANTEED PRODUCTS</h3>
									<p>All our products are under 2 years manufacturer's warranty. The supply of parts is free of charge in all production-related problems.</p>
								</div>
							</div>
						</div>
							...
							<div class="offer-item pgl-bg-light">
								<div class="offer-item-inner">
									<p><i class="icons icon-plane"></i></p>
									<h3>FROM TURKEY TO THE WORLD</h3>
									<p>Yapı Prefabrik exports prefabricated houses and construction site buildings to more than 20 countries</p>
								</div>
							</div>
						</div>
					...
					<div class="row">
							...
							<div class="pgl-property featured-item">
								<div class="property-thumb-info">
									<div class="property-thumb-info-image">
										<img alt="" class="img-responsive" src="<?php bloginfo('template_directory');?>/images/properties/property-featured-1.jpg">
									</div>
						...
						<div class="col-xs-6 col-md-3 animation">
							<div class="pgl-property featured-item">
								<div class="property-thumb-info">
									<div class="property-thumb-info-image">
										<img alt="" class="img-responsive" src="<?php bloginfo('template_directory');?>/images/properties/property-featured-2.jpg">
									</div>
									<div class="property-thumb-info-content">
						...
						<div class="col-xs-6 col-md-3 animation">
							<div class="pgl-property featured-item">
								<div class="property-thumb-info">
									<div class="property-thumb-info-image">
										<img alt="" class="img-responsive" src="<?php bloginfo('template_directory');?>/images/properties/property-featured-3.jpg">
									</div>
									<div class="property-thumb-info-content">
						...
						<div class="col-xs-6 col-md-3 animation">
							<div class="pgl-property featured-item">
								<div class="property-thumb-info">
									<div class="property-thumb-info-image">
										<img alt="" class="img-responsive" src="<?php bloginfo('template_directory');?>/images/properties/property-featured-4.jpg">
									</div>
									<div class="property-thumb-info-content">
						...
						<div class="col-xs-6 col-md-3 animation">
							<div class="pgl-property featured-item">
								<div class="property-thumb-info">
									<div class="property-thumb-info-image">
										<img alt="" class="img-responsive" src="<?php bloginfo('template_directory');?>/images/properties/property-featured-5.jpg">
									</div>
									<div class="property-thumb-info-content">
							...
							<div class="row">
								<div class="col-xs-4 animation">
									<div class="pgl-property">
										<div class="property-thumb-info">
											<div class="property-thumb-info-image">
												<img alt="" class="img-responsive" src="<?php bloginfo('template_directory');?>/images/properties/property-1.jpg">
								...
								<div class="col-xs-4 animation">
									<div class="pgl-property">
										<div class="property-thumb-info">
											<div class="property-thumb-info-image">
												<img alt="" class="img-responsive" src="<?php bloginfo('template_directory');?>/images/properties/property-2.jpg">
												<span class="property-thumb-info-label">
													<span class="label price">$358,000</span>
												</span>
											</div>
								...
								<div class="col-xs-4 animation">
									<div class="pgl-property">
										<div class="property-thumb-info">
											<div class="property-thumb-info-image">
												<img alt="" class="img-responsive" src="<?php bloginfo('template_directory');?>/images/properties/property-3.jpg">
												<span class="property-thumb-info-label">
													<span class="label price">$358,000</span>
							...
							<div class="row">
								<div class="col-xs-4 animation">
									<div class="pgl-property">
										<div class="property-thumb-info">
											<div class="property-thumb-info-image">
												<img alt="" class="img-responsive" src="<?php bloginfo('template_directory');?>/images/properties/property-4.jpg">
												<span class="property-thumb-info-label">
													<span class="label price">$358,000</span>
													<span class="label forrent">Rent</span>
												</span>
								...
								<div class="col-xs-4 animation">
									<div class="pgl-property">
										<div class="property-thumb-info">
											<div class="property-thumb-info-image">
												<img alt="" class="img-responsive" src="<?php bloginfo('template_directory');?>/images/properties/property-5.jpg">
												<span class="property-thumb-info-label">
													<span class="label price">$358,000</span>
												</span>
											</div>
								...
								<div class="col-xs-4 animation">
									<div class="pgl-property">
										<div class="property-thumb-info">
											<div class="property-thumb-info-image">
												<img alt="" class="img-responsive" src="<?php bloginfo('template_directory');?>/images/properties/property-6.jpg">
												<span class="property-thumb-info-label">
													<span class="label price">$358,000</span>
												</span>
											</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-4 animation about-item">
							<h2>Who We Are</h2>
							<p><img src="<?php bloginfo('template_directory');?>/images/content/demo-1.jpg" alt="" class="img-responsive"></p>
